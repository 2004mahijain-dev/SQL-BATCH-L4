-- last session constraints (foreign key)
-- data type in sql
...
insert into test13 values(9182.125, 9182.125), (10.120381232, 10.1203812320);
select * from test13;
...
-- varchar and char
-- varchar is datatype => strings / character values
